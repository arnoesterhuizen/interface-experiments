<?php $base_url = $_SERVER['REQUEST_SCHEME'] . '://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'];?>
<!DOCTYPE HTML>
<head>
...
<div id="preview"> <img src="<?php echo $base_url; ?>600x400/000/fff">
  <h2><a href="<?php echo $base_url; ?>600x400/000/fff" target="_blank"><?php echo $base_url; ?>600x400/000/fff</a></h2>
</div>
<form id="demo">
  <label for="size">Size
...
<p>width x height</p>
<ul>
  <li>Height is optional, if no height is specified the image will be a square. Example: <a href="<?php echo $base_url; ?>300" class="example correct"><?php echo $base_url; ?>300</a></li>
  <li><strong>Must</strong> be the first option in the url</li>
  <li>You can specify one dimension and a ratio and dummyimage will calculate the right value. Example: <a href="<?php echo $base_url; ?>640x4:3" class="example correct"><?php echo $base_url; ?>640x4:3</a> or <a href="<?php echo $base_url; ?>16:9x1080" class="example correct"><?php echo $base_url; ?>16:9x1080</a></li>
</ul>
<h4 id="color">Colors</h4>
<p>background color / text color</p>
<ul>
  <li>Colors are represented as hex codes (#ffffff is white)</li>
  <li>Colors always follow the dimensions, <a href="<?php echo $base_url; ?>250/ffffff/000000" target="_blank" class="example correct"><?php echo $base_url; ?>250/ffffff/000000</a> not <a href="<?php echo $base_url; ?>ffffff/250/000000" target="_blank" class="example incorrect"><?php echo $base_url; ?>ffffff/250/000000</a></li>
  ...
  <li>Standard image sizes are also available. See the <a href="#standards">complete list</a>.
    <ul>
      <li><a href="<?php echo $base_url; ?>qvga" target="_blank" class="example correct"><?php echo $base_url; ?>qvga</a></li>
      <li><a href="<?php echo $base_url; ?>skyscraper/f0f/f" target="_blank" class="example correct"><?php echo $base_url; ?>skyscraper/f0f/f</a></li>
    </ul>
  </li>
</ul>
...
<ul>
  ...
  <li>The image extension can go at the end of any option in the url
    <ul>
      <li><a href="<?php echo $base_url; ?>300.png/09f/fff" target="_blank" class="example correct"><?php echo $base_url; ?>300.png/09f/fff</a></li>
      <li><a href="<?php echo $base_url; ?>300/09f.png/fff" target="_blank" class="example correct"><?php echo $base_url; ?>300/09f.png/fff</a></li>
      <li><a href="<?php echo $base_url; ?>300/09f/fff.png" target="_blank" class="example correct"><?php echo $base_url; ?>300/09f/fff.png</a></li>
    </ul>
  </li>
</ul>
...
<ul>
  ...
  <li>Spaces become +
    <ul>
      <li><a href="<?php echo $base_url; ?>200x300&text=dummyimage.com+rocks!" target="_blank" class="example correct"><?php echo $base_url; ?>200x300&amp;text=dummyimage.com+rocks!</a></li>
    </ul>
  </li>
...
<table id="special-characters">
    ...
    <tbody>
    	<tr>
        	<td>+</td>
            <td><a href="<?php echo $base_url; ?>480&text=Plus+Sign=0x2B">0x2B</a></td>
        </tr>
    	<tr>
        	<td>#</td>
            <td><a href="<?php echo $base_url; ?>480&text=Number+sign+(Octothorp)=0x23">0x23</a></td>
        </tr>
    	<tr>
        	<td>%</td>
            <td><a href="<?php echo $base_url; ?>480&text=Percent+symbol=0x25">0x25</a></td>
        </tr>
    	<tr>
        	<td>&amp;</td>
            <td><a href="<?php echo $base_url; ?>480&text=Ampersand=0x26">0x26</a></td>
        </tr>
    </tbody>
</table>
<p>You'll run into problems trying to manually enter a dimension as text if the numbers use the UTf-8 Hex values above, like <a href="<?php echo $base_url; ?>480&text=400x250">&amp;text=400x250</a>. Use a multiplication symbol, &#215; instead (not an x character) to get around this, <a href="<?php echo $base_url; ?>480&text=400×250">&amp;text=400&#215;250</a>.</p>
...
<table>
  ...
  <tbody>
    <tr>
      <td><a href="<?php echo $base_url; ?>mediumrectangle">mediumrectangle</a></td>
      <td><a href="<?php echo $base_url; ?>medrect">medrect</a></td>
      <td>300&times;250</td>
      <td>^(med)\w+(rec\w+)</td>
    </tr>
    <tr>
      <td><a href="<?php echo $base_url; ?>squarepopup">squarepopup</a></td>
      <td><a href="<?php echo $base_url; ?>sqrpop">sqrpop</a></td>
      <td>250&times;250</td>
      <td>^(s\w+pop)</td>
    </tr>
    <tr>
      <td><a href="<?php echo $base_url; ?>verticalrectangle">verticalrectangle</a></td>
      <td><a href="<?php echo $base_url; ?>vertrec">vertrec</a></td>
      <td>240&times;400</td>
      <td>^(ver)\w+(rec)</td>
    </tr>
    <tr>
      <td><a href="<?php echo $base_url; ?>largerectangle">largerectangle</a></td>
      <td><a href="<?php echo $base_url; ?>lrgrec">lrgrec</a></td>
      <td>336&times;280</td>
      <td>^(large|lrg)(rec)</td>
    </tr>
    <tr>
      <td><a href="<?php echo $base_url; ?>rectangle">rectangle</a></td>
      <td><a href="<?php echo $base_url; ?>rec">rec</a></td>
      <td>180&times;150</td>
      <td> ^(rec)</td>
    </tr>
    <tr>
      <td><a href="<?php echo $base_url; ?>popunder">popunder</a></td>
      <td><a href="<?php echo $base_url; ?>pop">pop</a></td>
      <td>720&times;300</td>
      <td>^(pop)</td>
    </tr>
    <tr>
      <td><a href="<?php echo $base_url; ?>fullbanner">fullbanner</a></td>
      <td><a href="<?php echo $base_url; ?>fullban">fullban</a></td>
      <td>468&times;60</td>
      <td>^(f\w+ban)</td>
    </tr>
    <tr>
      <td><a href="<?php echo $base_url; ?>halfbanner">halfbanner</a></td>
      <td><a href="<?php echo $base_url; ?>halfban">halfban</a></td>
      <td>234&times;60</td>
      <td>^(h\w+ban)</td>
    </tr>
    <tr>
      <td><a href="<?php echo $base_url; ?>microbar">microbar</a></td>
      <td><a href="<?php echo $base_url; ?>mibar">mibar</a></td>
      <td>88&times;31</td>
      <td>^(m\w+bar)</td>
    </tr>
    <tr>
      <td><a href="<?php echo $base_url; ?>button1">button1</a></td>
      <td><a href="<?php echo $base_url; ?>but1">but1</a></td>
      <td>120&times;90</td>
      <td>^(b\w+1)</td>
    </tr>
    <tr>
      <td><a href="<?php echo $base_url; ?>button2">button2</a></td>
      <td><a href="<?php echo $base_url; ?>but2">but2</a></td>
      <td>120&times;60</td>
      <td>^(b\w+2)</td>
    </tr>
    <tr>
      <td><a href="<?php echo $base_url; ?>verticalbanner">verticalbanner</a></td>
      <td><a href="<?php echo $base_url; ?>vertban">vertban</a></td>
      <td>120&times;240</td>
      <td>^(ver\w+ban)</td>
    </tr>
    <tr>
      <td><a href="<?php echo $base_url; ?>squarebutton">squarebutton</a></td>
      <td><a href="<?php echo $base_url; ?>sqrbut">sqrbut</a></td>
      <td>125&times;125</td>
      <td>^(s\w+but)</td>
    </tr>
    <tr>
      <td><a href="<?php echo $base_url; ?>leaderboard">leaderboard</a></td>
      <td><a href="<?php echo $base_url; ?>leadbrd">leadbrd</a></td>
      <td>728&times;90</td>
      <td>^(lea\w+rd)</td>
    </tr>
    <tr>
      <td><a href="<?php echo $base_url; ?>wideskyscraper">wideskyscraper</a></td>
      <td><a href="<?php echo $base_url; ?>wiskyscrpr">wiskyscrpr</a></td>
      <td>160&times;600</td>
      <td>^(w\w+sk\w+r)</td>
    </tr>
    <tr>
      <td><a href="<?php echo $base_url; ?>skyscraper">skyscraper</a></td>
      <td><a href="<?php echo $base_url; ?>skyscrpr">skyscrpr</a></td>
      <td>120&times;600</td>
      <td>^(sk\w+r)</td>
    </tr>
    <tr>
      <td><a href="<?php echo $base_url; ?>halfpage">halfpage</a></td>
      <td><a href="<?php echo $base_url; ?>hpge">hpge</a></td>
      <td>300&times;600</td>
      <td>^(h\w+g)</td>
    </tr>
  </tbody>
...
<table>
  ...
  <tbody>
    <tr>
      <td><a href="<?php echo $base_url; ?>cga">cga</a></td>
      <td>320x200</td>
    </tr>
    <tr>
      <td><a href="<?php echo $base_url; ?>qvga">qvga</a></td>
      <td>320x240</td>
    </tr>
    <tr>
      <td><a href="<?php echo $base_url; ?>vga">vga</a></td>
      <td>640x480</td>
    </tr>
    <tr>
      <td><a href="<?php echo $base_url; ?>wvga">wvga</a></td>
      <td>800x480</td>
    </tr>
    <tr>
      <td><a href="<?php echo $base_url; ?>svga">svga</a></td>
      <td>800x480</td>
    </tr>
    <tr>
      <td><a href="<?php echo $base_url; ?>wsvga">wsvga</a></td>
      <td>1024x600</td>
    </tr>
    <tr>
      <td><a href="<?php echo $base_url; ?>xga">xga</a></td>
      <td>1024x768</td>
    </tr>
    <tr>
      <td><a href="<?php echo $base_url; ?>wxga">wxga</a></td>
      <td>1280x800</td>
    </tr>
    <tr>
      <td><a href="<?php echo $base_url; ?>wsxga">wsxga</a></td>
      <td>1440x900</td>
    </tr>
    <tr>
      <td><a href="<?php echo $base_url; ?>wuxga">wuxga</a></td>
      <td>1920x1200</td>
    </tr>
    <tr>
      <td><a href="<?php echo $base_url; ?>wqxga">wqxga</a></td>
      <td>2560x1600</td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      <td><a href="<?php echo $base_url; ?>ntsc">ntsc</a></td>
      <td>720x480</td>
    </tr>
    <tr>
      <td><a href="<?php echo $base_url; ?>pal">pal</a></td>
      <td>768x576</td>
    </tr>
    <tr>
      <td><a href="<?php echo $base_url; ?>hd720">hd720</a></td>
      <td>1280x720</td>
    </tr>
    <tr>
      <td><a href="<?php echo $base_url; ?>hd1080">hd1080</a></td>
      <td>1920x1080</td>
    </tr>
  </tbody>
</table>
...
<ul>
  ...
  <li>Dummyimage.com uses a <a href="<?php echo $base_url; ?>crossdomain.xml" class="example">crossdomain.xml</a> file</li>
</ul>
